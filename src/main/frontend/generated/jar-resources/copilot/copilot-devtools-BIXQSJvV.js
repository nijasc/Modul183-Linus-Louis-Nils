...
import {i as t} from "./icons-DHFxWkZw.js";
...
const S = "bg-[linear-gradient(to_right,var(--amber-3),var(--amber-5),var(--amber-3),var(--amber-6))] dark:bg-[linear-gradient(to_right,var(--amber-5),var(--amber-7),var(--amber-5),var(--amber-8))]",
    P = "bg-[linear-gradient(to_right,var(--blue-3),var(--blue-5),var(--blue-3),var(--blue-6))] dark:bg-[linear-gradient(to_right,var(--blue-4),var(--blue-6),var(--blue-4),var(--blue-7))]",
    E = "bg-[linear-gradient(to_right,var(--ruby-3),var(--ruby-5),var(--ruby-3),var(--ruby-6))] dark:bg-[linear-gradient(to_right,var(--ruby-4),var(--ruby-6),var(--ruby-4),var(--ruby-7))]",
    A = "bg-[linear-gradient(to_right,var(--teal-3),var(--teal-5),var(--teal-3),var(--teal-6))] dark:bg-[linear-gradient(to_right,var(--teal-4),var(--teal-6),var(--teal-4),var(--teal-7))]";
let g = class extends h {
    ...
    renderWelcomeToVersion() {
      ...
      <vaadin-button
        ...
        <span class="flex flex-col">
          ...
          <span class="text-teal-11 text-xs">Click for release notes</span>
        </span>
      </vaadin-button>
      <vaadin-button
    ...
    renderDevelopmentWorkflow() {
        const e = y(), n = k(), a = this.getDevelopmentWorkflowConfig(e, n), r = a?.bgClass ?? "",
            s = a?.colorClass ?? "", p = this.resolveIcon(a), u = a?.rotateIcon ? `rotate-180 ${s}` : s,
            b = this.resolveTitle(a), f = a?.displayMessage ?? "";
        return o`
      <vaadin-button
