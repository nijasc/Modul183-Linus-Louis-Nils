...
function On(t, e) {
  ...
  function n(s, l) {
    var c, d, p = tt(s)[g], v = new Ae(l, (c = (d = r.options_) == null ? void 0 : d.enhancer) != null ? c : Ve, process.env.NODE_ENV !== "production" ? p.name_ + "." + a.toString() : "ObservableObject." + a.toString(), !1);
...
}, k = /* @__PURE__ */ xa(Ra, jn), qa = "computed", Wn = "computed.struct", Mr = /* @__PURE__ */ $r(qa), Fn = /* @__PURE__ */ $r(Wn, {
...
var to = "action", ss = "action.bound", Qa = "autoAction", ls = "autoAction.bound", Ba = "<unnamed action>", jr = /* @__PURE__ */ At(to), cs = /* @__PURE__ */ At(ss, {
  bound: !0
}), Wr = /* @__PURE__ */ At(Qa, {
  autoAction: !0
}), ds = /* @__PURE__ */ At(ls, {
...
function ro(t, e, r) {
  ...
  var n = (o = r.name) != null ? o : process.env.NODE_ENV !== "production" ? "Reaction@" + X() : "Reaction", s = Se(n, r.onError ? ps(r.onError, e) : e), l = !r.scheduler && !r.delay, c = _a(r), d = !0, p = !1, v, b = r.compareStructural ? Ye.structural : r.equals || Ye.default, w = new te(n, function() {
    d || l ? N() : p || (p = !0, c(N));
...
var Or = /* @__PURE__ */ Na("flow"), ys = /* @__PURE__ */ Na("flow.bound", {
  ...
  var o = e, a = o.name || "<unnamed flow>", i = function() {
    var s = this, l = arguments, c = ++ms, d = Se(a + " - runid: " + c + " - init", o).apply(s, l), p, v = void 0, b = new Promise(function(w, N) {
      var T = 0;
      p = N;
      function me(D) {
        v = void 0;
...
var Ts = {}, he = "add", Yt = "delete", ii = /* @__PURE__ */ function() {
  ...
  return e.has_ = function(o) {
    ...
    G(this.keysAtom_), se(function() {
      var c, d = new Ae(a, i.enhancer_, process.env.NODE_ENV !== "production" ? i.name_ + "." + Rr(o) : "ObservableMap.key", !1);
...
Extending builtins is not supported.`), t;
  ...
  var o = (r = e?.name) != null ? r : process.env.NODE_ENV !== "production" ? (C(t) ? "ObservableObject" : t.constructor.name) + "@" + X() : "ObservableObject", a = new Fr(t, /* @__PURE__ */ new Map(), String(o), Un(e));
  return cr(t, g, a), t;
}
...
const mr = async (t, e, r) => window.Vaadin.copilot.comm(t, e, r), ot = "copilot-", ul = "25.1.2", pl = "undefined", Cd = "attention-required", Nd = "https://plugins.jetbrains.com/plugin/23758-vaadin", Td = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode", Dd = "https://marketplace.eclipse.org/content/vaadin-tools";
function zd(t) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const jt = globalThis, no = jt.ShadowRoot && (jt.ShadyCSS === void 0 || jt.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, so = Symbol(), Qo = /* @__PURE__ */ new WeakMap();
let Ai = class {
  constructor(e, r, o) {
...
const { is: Ml, defineProperty: Ul, getOwnPropertyDescriptor: Zl, getOwnPropertyNames: jl, getOwnPropertySymbols: Wl, getPrototypeOf: Fl } = Object, wr = globalThis, Yo = wr.trustedTypes, Xl = Yo ? Yo.emptyScript : "", Hl = wr.reactiveElementPolyfillSupport, vt = (t, e) => t, ar = { toAttribute(t, e) {
  ...
  return r;
} }, lo = (t, e) => !Ml(t, e), Go = { attribute: !0, type: String, converter: ar, reflect: !1, useDefault: !1, hasChanged: lo };
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const uo = globalThis, ir = uo.trustedTypes, $o = ir ? ir.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, Pi = "$lit$", pe = `lit$${Math.random().toFixed(9).slice(2)}$`, Vi = "?" + pe, Gl = `<${Vi}>`, Ie = document, wt = () => Ie.createComment(""), xt = (t) => t === null || typeof t != "object" && typeof t != "function", po = Array.isArray, _l = (t) => po(t) || typeof t?.[Symbol.iterator] == "function", Cr = `[ 	
\f\r]`, lt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ea = /-->/g, ta = />/g, xe = RegExp(`>|${Cr}(?:([^\\s"'>=/]+)(${Cr}*=${Cr}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ra = /'/g, oa = /"/g, Ci = /^(?:script|style|textarea|title)$/i, Ni = (t) => (e, ...r) => ({ _$litType$: t, strings: e, values: r }), ce = Ni(1), Fd = Ni(2), Re = Symbol.for("lit-noChange"), S = Symbol.for("lit-nothing"), aa = /* @__PURE__ */ new WeakMap(), Ee = Ie.createTreeWalker(Ie, 129);
function Ti(t, e) {
    ...
    for (; (a = Ee.nextNode()) !== null && l.length < s; ) {
      if (a.nodeType === 1) {
        if (a.hasAttributes()) for (const p of a.getAttributeNames()) if (p.endsWith(Pi)) {
          ...
          l.push({ type: 1, index: i, name: w[2], strings: b, ctor: w[1] === "." ? tc : w[1] === "?" ? rc : w[1] === "@" ? oc : xr }), a.removeAttribute(p);
...
const Jr = window.Vaadin.copilot.overlayManager, pc = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
