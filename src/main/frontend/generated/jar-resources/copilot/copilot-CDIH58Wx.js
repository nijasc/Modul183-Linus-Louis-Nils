...
function hn(t, e) {
    ...
    var r = e.kind, o = e.name, a = e.addInitializer, i = this, n = function (c) {
        var d, p, v, b;
        return Ce((d = (p = i.options_) == null ? void 0 : p.name) != null ? d : o.toString(), c, (v = (b = i.options_) == null ? void 0 : b.autoAction) != null ? v : !1);
    };
    if (r == "field")
        return function (l) {
            var c, d = l;
...
function Ca(t, e, r, o, a) {
    var i, n, s, l, c, d, p;
    a === void 0 && (a = u.safeDescriptors), vn(t, e, r, o);
    var v = o.value;
...
function Ta(t, e, r, o, a, i) {
    i === void 0 && (i = u.safeDescriptors), mn(t, e, r, o);
    var n = o.value;
    if (mt(n) || (n = Ge(n)), a) {
        var s;
...
function On(t, e) {
    ...
    function n(s, l) {
        var c, d, p = tt(s)[g],
            v = new Ae(l, (c = (d = r.options_) == null ? void 0 : d.enhancer) != null ? c : Ve, process.env.NODE_ENV !== "production" ? p.name_ + "." + a.toString() : "ObservableObject." + a.toString(), !1);
        p.values_.set(a, v), i.add(s);
    }
...
function Cn(t, e, r, o) {
    ...
    var p = ((a = this.options_) == null ? void 0 : a.deep) === !1 ? k.ref : k;
...
var Lr = /* @__PURE__ */ pr(Dn), qn = /* @__PURE__ */ pr(zn, {
    enhancer: ur
}), Ln = /* @__PURE__ */ pr(In, {
    enhancer: ln
}), Mn = /* @__PURE__ */ pr(Rn, {
...
function Dt(t) {
    return t.deep === !0 ? Ve : t.deep === !1 ? ur : Zn(t.defaultDecorator);
}
...
var jn = {
        ...
        array: function (e, r) {
            var o = Tt(r);
            return (u.useProxies === !1 || o.proxy === !1 ? Us : Cs)(e, Dt(o), o.name);
        },
        map: function (e, r) {
            var o = Tt(r);
        ...
        object: function (e, r, o) {
            return Ue(function () {
                return ti(u.useProxies === !1 || o?.proxy === !1 ? tt({}, o) : As({}, o), e, r);
            });
        },
        ref: /* @__PURE__ */ ee(qn),
    ...
    }, k = /* @__PURE__ */ xa(Ra, jn), qa = "computed", Wn = "computed.struct", Mr = /* @__PURE__ */ $r(qa),
    Fn = /* @__PURE__ */ $r(Wn, {
        equals: Ye.structural
    }), hr = function (e, r) {
        if (Ot(r))
            return Mr.decorate_20223_(e, r);
        if (Pe(r))
            return Et(e, r, Mr);
        if (C(e))
            return ee($r(qa, e));
...
function Kn(t) {
    Jt !== t.actionId_ && h(30), Jt = t.parentActionId_, t.error_ !== void 0 && (u.suppressReactionErrors = !0), fr(t.prevAllowStateChanges_), ht(t.prevAllowStateReads_), j(), t.runAsAction_ && le(t.prevDerivation_), process.env.NODE_ENV !== "production" && t.notifySpy_ && q({
...
var Bn = "create", Ae = /* @__PURE__ */ function (t) {
    ...
    return r.dehanceValue = function (a) {
        ...
        var i = this.value_;
        if (a = this.prepareNewValue_(a), a !== u.UNCHANGED) {
            var n = P();
        ...
        return a = this.enhancer(a, this.value_, this.name_), this.equals(this.value_, a) ? u.UNCHANGED : a;
    ...
    return e.onBecomeStale_ = function () {
        ...
        this.observers_.size === 0 && !this.keepAlive_)
            Ur(this) && (this.warnAboutUntrackedRead_(), Z(), this.value_ = this.computeValue_(!1), j());
        else if (Fa(this), Ur(this)) {
            var o = u.trackingContext;
            this.keepAlive_ && !o && (u.trackingContext = this), this.trackAndCompute() && es(this), u.trackingContext = o;
        }
        var a = this.value_;
        if (Zt(a))
            throw a.cause;
        ...
        this.keepAlive_ || (Zr(this), this.value_ = void 0, process.env.NODE_ENV !== "production" && this.isTracing_ !== W.NONE && console.log("[mobx.trace] Computed value '" + this.name_ + "' was suspended and it will recompute on the next access."));
...
function Ur(t) {
    switch (t.dependenciesState_) {
        ...
        case m.POSSIBLY_STALE_: {
            for (var e = eo(!0), r = Me(), o = t.observing_, a = o.length, i = 0; i < a; i++) {
                var n = o[i];
                if (gr(n)) {
...
function Ma(t, e, r) {
    ...
    return u.inBatch--, u.trackingDerivation = a, _n(t), Gn(t), ht(o), i;
}
...
function Fa(t) {
    ...
    return e !== null ? (e.runId_ !== t.lastAccessedBy_ && (t.lastAccessedBy_ = e.runId_, e.newObserving_[e.unboundDepsCount_++] = t, !t.isBeingObserved && u.trackingContext && (t.isBeingObserved = !0, t.onBO())), t.isBeingObserved) : (t.observers_.size === 0 && u.inBatch > 0 && Wa(t), !1);
}
...
var te = /* @__PURE__ */ function () {
    ...
    return e.onBecomeStale_ = function () {
        ...
        this.isScheduled || (this.isScheduled = !0, u.pendingReactions.push(this), Ka());
    }, e.runReaction_ = function () {
        if (!this.isDisposed) {
            Z(), this.isScheduled = !1;
            var o = u.trackingContext;
            if (u.trackingContext = this, Ur(this)) {
        ...
        if (!this.isDisposed) {
            ...
            u.trackingContext = n, this.isRunning = !1, this.isTrackPending = !1, this.isDisposed && Zr(this), Zt(s) && this.reportExceptionInDerivation_(s.cause), process.env.NODE_ENV !== "production" && a && q({
                time: Date.now() - i
            }), j();
        }
        ...
        u.suppressReactionErrors ? process.env.NODE_ENV !== "production" && console.warn("[mobx] (error in reaction '" + this.name_ + "' suppressed, fix error of causing action below)") : console.error(i, o), process.env.NODE_ENV !== "production" && P() && Ne({
            type: "error",
            name: this.name_,
            message: i,
            error: "" + o
        ...
        this.isDisposed || (this.isDisposed = !0, this.isRunning || (Z(), Zr(this), j()));
...
function Ka() {
    u.inBatch > 0 || u.isRunningReactions || os(as);
}
...
function ns(t) {
    ...
    }) : (u.spyListeners.push(t), Gr(function () {
...
var to = "action", ss = "action.bound", Qa = "autoAction", ls = "autoAction.bound", Ba = "<unnamed action>",
    jr = /* @__PURE__ */ At(to), cs = /* @__PURE__ */ At(ss, {
        bound: !0
    }), Wr = /* @__PURE__ */ At(Qa, {
        autoAction: !0
    }), ds = /* @__PURE__ */ At(ls, {
...
function Ya(t) {
    var e = function (o, a) {
        ...
        if (E(a))
            return Ce(o, a, t);
        if (Ot(a))
            return (t ? Wr : jr).decorate_20223_(o, a);
        if (Pe(a))
            return Et(o, a, t ? Wr : jr);
        if (Pe(o))
            return ee(At(t ? Qa : to, {
                name: o,
                autoAction: t
            }));
...
function Ga(t, e) {
    var r, o, a, i;
    e === void 0 && (e = Yr), process.env.NODE_ENV !== "production" && (E(t) || h("Autorun expects a function as first argument"), Te(t) && h("Autorun does not accept actions since actions are untrackable"));
    var n = (r = (o = e) == null ? void 0 : o.name) != null ? r : process.env.NODE_ENV !== "production" ? t.name || "Autorun@" + X() : "Autorun",
        s = !e.scheduler && !e.delay, l;
    if (s)
        l = new te(n, function () {
            this.track(p);
...
function ro(t, e, r) {
    var o, a, i;
    r === void 0 && (r = Yr), process.env.NODE_ENV !== "production" && ((!E(t) || !E(e)) && h("First and second argument to reaction should be functions"), C(r) || h("Third argument of reactions should be an object"));
    var n = (o = r.name) != null ? o : process.env.NODE_ENV !== "production" ? "Reaction@" + X() : "Reaction",
        s = Se(n, r.onError ? ps(r.onError, e) : e), l = !r.scheduler && !r.delay, c = _a(r), d = !0, p = !1, v,
        b = r.compareStructural ? Ye.structural : r.equals || Ye.default, w = new te(n, function () {
            d || l ? N() : p || (p = !0, c(N));
...
var Or = /* @__PURE__ */ Na("flow"), ys = /* @__PURE__ */ Na("flow.bound", {
    bound: !0
    ...
    var o = e, a = o.name || "<unnamed flow>", i = function () {
        var s = this, l = arguments, c = ++ms, d = Se(a + " - runid: " + c + " - init", o).apply(s, l), p, v = void 0,
            b = new Promise(function (w, N) {
                ...
                function me(D) {
                    ...
                    var ue;
                    try {
                        ue = Se(a + " - runid: " + c + " - yield " + T++, d.next).call(d, D);
                    } catch (ye) {
                        return N(ye);
                    }
                    nt(ue);
                ...
                function je(D) {
                    ...
                    var ue;
                    try {
                        ue = Se(a + " - runid: " + c + " - yield " + T++, d.throw).call(d, D);
                    } catch (ye) {
                        return N(ye);
                    }
                    nt(ue);
...
function ws(t, e) {
    return t ? rt(t) || !!t[g] || _r(t) || Qt(t) || gr(t) : !1;
}
...
function Ct(t, e, r) {
    return process.env.NODE_ENV !== "production" && (!C(t) && !C(Object.getPrototypeOf(t)) && h("'makeAutoObservable' can only be used for classes that don't have a superclass"), rt(t) && h("makeAutoObservable can only be used on objects not already made observable")), C(t) ? ti(t, t, e, r) : (Ue(function () {
        ...
        if (!t[Ar]) {
            ...
            i.delete("constructor"), i.delete(g), cr(a, Ar, i);
        }
...
var Oo = "splice", H = "update", Ps = 1e4, Vs = {
    ...
    return e.dehanceValue_ = function (o) {
        ...
        if (i = i.length === 0 ? i : i.map(function (p) {
...
var Ns = /* @__PURE__ */ Le("ObservableArrayAdministration", oo);
...
var Ts = {}, he = "add", Yt = "delete", ii = /* @__PURE__ */ function () {
    ...
    return e.has_ = function (o) {
        ...
        if (!i) {
            var n = i = new Ae(this.has_(o), ur, process.env.NODE_ENV !== "production" ? this.name_ + "." + Rr(o) + "?" : "ObservableMap.key?", !1);
        ...
        if (a = i.prepareNewValue_(a), a !== u.UNCHANGED) {
            var n = P(), s = K(this), l = s || n ? {
                observableKind: "map",
                debugObjectName: this.name_,
                type: H,
        ...
        G(this.keysAtom_), se(function () {
            var c,
                d = new Ae(a, i.enhancer_, process.env.NODE_ENV !== "production" ? i.name_ + "." + Rr(o) : "ObservableMap.key", !1);
        ...
        return se(function () {
            ...
            if (!s)
                if (a.data_.size !== n.size)
                    ...
                    for (var D = a.data_.keys(), ue = n.keys(), ye = D.next(), mo = ue.next(); !ye.done;) {
                        if (ye.value !== mo.value) {
                            a.keysAtom_.reportChanged();
                            break;
                        }
                        ye = D.next(), mo = ue.next();
                    }
            a.data_ = n;
        }), this;
    }, e.toString = function () {
...
function Ao(t) {
    return t[Symbol.toStringTag] = "MapIterator", io(t);
}
...
function Po(t) {
    return t[Symbol.toStringTag] = "SetIterator", io(t);
}

var Vo = /* @__PURE__ */ Object.create(null), Co = "remove", Fr = /* @__PURE__ */ function () {
    function t(r, o, a, i) {
    ...
    return e.getObservablePropValue_ = function (o) {
        ...
        return a || (a = new Ae(o in this.target_, ur, process.env.NODE_ENV !== "production" ? this.name_ + "." + Rr(o) + "?" : "ObservableObject.key?", !1), this.pendingKeys_.set(o, a)), a.get();
        ...
        try {
            ...
            if (n) {
                ...
                $(this.target_, o, d);
            var p = new Ae(a, i, process.env.NODE_ENV !== "production" ? this.name_ + "." + o.toString() : "ObservableObject.key", !1);
...
function tt(t, e) {
    ...
    if (process.env.NODE_ENV !== "production" && e && rt(t) && h("Options can't be provided for already observable objects."), J(t, g))
        return process.env.NODE_ENV !== "production" && !(Nt(t) instanceof Fr) && h("Cannot convert '" + Gt(t) + `' into observable object:
...
Extending builtins is not supported.`), t;
    ...
    var o = (r = e?.name) != null ? r : process.env.NODE_ENV !== "production" ? (C(t) ? "ObservableObject" : t.constructor.name) + "@" + X() : "ObservableObject",
        a = new Fr(t, /* @__PURE__ */ new Map(), String(o), Un(e));
    return cr(t, g, a), t;
}

var Is = /* @__PURE__ */ Le("ObservableObjectAdministration", Fr);
...
function Do(t, e, r) {
    if (process.env.NODE_ENV !== "production" && !ui(e) && h("Cannot annotate '" + t.name_ + "." + r.toString() + "': Invalid annotation."), process.env.NODE_ENV !== "production" && !Ht(e) && J(t.appliedAnnotations_, r)) {
...
function di(t, e, r) {
    return r === void 0 && (r = -1), Xr(t, e, r);
}

function Xr(t, e, r, o, a) {
    if (t === e)
        return t !== 0 || 1 / t === 1 / e;
    if (t == null || e == null)
        return !1;
...
var Ro, Zs = ((Ro = Br().Iterator) == null ? void 0 : Ro.prototype) || {};
...
const Xs = Symbol.for("react.portal"), Hs = Symbol.for("react.fragment"), Js = Symbol.for("react.strict_mode"),
    Ks = Symbol.for("react.profiler"), Qs = Symbol.for("react.provider"), Bs = Symbol.for("react.context"),
    pi = Symbol.for("react.forward_ref"), Ys = Symbol.for("react.suspense"), Gs = Symbol.for("react.suspense_list"),
    _s = Symbol.for("react.memo"), $s = Symbol.for("react.lazy");
...
function ut(t) {
    const e = t.type;
    return e?.$$typeof === pi && !e.displayName && t.child ? ut(t.child) : _t(t.type) ?? _t(t.elementType) ?? "???";
}
...
const mr = async (t, e, r) => window.Vaadin.copilot.comm(t, e, r), ot = "copilot-", ul = "25.1.2", pl = "undefined",
    Cd = "attention-required", Nd = "https://plugins.jetbrains.com/plugin/23758-vaadin",
    Td = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode",
    Dd = "https://marketplace.eclipse.org/content/vaadin-tools";
...
function El(t) {
    ...
    for (; e && e !== document.body;) {
        const r = window.getComputedStyle(e), o = r.overflowY, a = r.overflowX,
...
class Il {
    constructor() {
        this.supportsHilla = !0, this.springSecurityEnabled = !1, this.springJpaDataEnabled = !1, this.springJpaDatasourceInitialization = !1, this.springApplication = !1, this.urlPrefix = "", this.serverVersions = [], this.clientVersions = [{
            name: "Browser",
...
class Rl {
    ...
    addPaletteCustomComponent(e) {
        return (this.palette?.components ?? []).find((a) => Vr(a, e)) ? !1 : (this.palette || (this.palette = {components: []}), this.palette = JSON.parse(JSON.stringify(this.palette)), this.palette.components.push(e), !0);
    }
    ...
    updatePaletteCustomComponent(e, r) {
        if (!this.palette || !this.palette.components)
            return;
        const o = [...this.palette.components], a = o.findIndex((i) => Vr(i, e));
 ...
 */
const jt = globalThis,
    no = jt.ShadowRoot && (jt.ShadyCSS === void 0 || jt.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype,
    so = Symbol(), Qo = /* @__PURE__ */ new WeakMap();
let Ai = class {
    constructor(e, r, o) {
        if (this._$cssResult$ = !0, o !== so) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
...
const V = (t) => new Ai(typeof t == "string" ? t : t + "", void 0, so), ql = (t, ...e) => {
    const r = t.length === 1 ? t[0] : e.reduce((o, a, i) => o + ((n) => {
        if (n._$cssResult$ === !0) return n.cssText;
        if (typeof n == "number") return n;
        throw Error("Value passed to 'css' function must be a 'css' function result: " + n + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
    })(a) + t[i + 1], t[0]);
    return new Ai(r, t, so);
}, Ll = (t, e) => {
    if (no) t.adoptedStyleSheets = e.map((r) => r instanceof CSSStyleSheet ? r : r.styleSheet);
...
}, Bo = no ? (t) => t : (t) => t instanceof CSSStyleSheet ? ((e) => {
    let r = "";
...
const {
        ...
        getPrototypeOf: Fl
    } = Object, wr = globalThis, Yo = wr.trustedTypes, Xl = Yo ? Yo.emptyScript : "",
    Hl = wr.reactiveElementPolyfillSupport, vt = (t, e) => t, ar = {
        toAttribute(t, e) {
            switch (e) {
                case Boolean:
                    t = t ? Xl : null;
    ...
    Go = {attribute: !0, type: String, converter: ar, reflect: !1, useDefault: !1, hasChanged: lo};
...
let He = class extends HTMLElement {
    ...
    requestUpdate(e, r, o) {
        if (e !== void 0) {
            ...
            if (o ??= a.getPropertyOptions(e), !((o.hasChanged ?? lo)(i, r) || o.useDefault && o.reflect && i === this._$Ej?.get(e) && !this.hasAttribute(a._$Eu(e, o)))) return;
            this.C(e, r, o);
        }
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Jl = {attribute: !0, type: String, converter: ar, reflect: !1, hasChanged: lo}, Kl = (t = Jl, e, r) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const uo = globalThis, ir = uo.trustedTypes, $o = ir ? ir.createPolicy("lit-html", {createHTML: (t) => t}) : void 0,
    Pi = "$lit$", pe = `lit$${Math.random().toFixed(9).slice(2)}$`, Vi = "?" + pe, Gl = `<${Vi}>`, Ie = document,
    wt = () => Ie.createComment(""), xt = (t) => t === null || typeof t != "object" && typeof t != "function",
    po = Array.isArray, _l = (t) => po(t) || typeof t?.[Symbol.iterator] == "function", Cr = `[ 	
\f\r]`, lt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ea = /-->/g, ta = />/g,
    xe = RegExp(`>|${Cr}(?:([^\\s"'>=/]+)(${Cr}*=${Cr}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ra = /'/g, oa = /"/g, Ci = /^(?:script|style|textarea|title)$/i,
    Ni = (t) => (e, ...r) => ({_$litType$: t, strings: e, values: r}), ce = Ni(1), Fd = Ni(2),
    Re = Symbol.for("lit-noChange"), S = Symbol.for("lit-nothing"), aa = /* @__PURE__ */ new WeakMap(),
    Ee = Ie.createTreeWalker(Ie, 129);

function Ti(t, e) {
    if (!po(t) || !t.hasOwnProperty("raw")) throw Error("invalid template strings array");
...
const $l = (t, e) => {
    ...
    for (let s = 0; s < r; s++) {
        const l = t[s];
        let c, d, p = -1, v = 0;
        for (; v < l.length && (n.lastIndex = v, d = n.exec(l), d !== null);) v = n.lastIndex, n === lt ? d[1] === "!--" ? n = ea : d[1] !== void 0 ? n = ta : d[2] !== void 0 ? (Ci.test(d[2]) && (a = RegExp("</" + d[2], "g")), n = xe) : d[3] !== void 0 && (n = xe) : n === xe ? d[0] === ">" ? (n = a ?? lt, p = -1) : d[1] === void 0 ? p = -2 : (p = n.lastIndex - d[2].length, c = d[1], n = d[3] === void 0 ? xe : d[3] === '"' ? oa : ra) : n === oa || n === ra ? n = xe : n === ea || n === ta ? n = lt : (n = xe, a = void 0);
        const b = n === xe && t[s + 1].startsWith("/>") ? " " : "";
        i += n === lt ? l + Gl : p >= 0 ? (o.push(c), l.slice(0, p) + Pi + l.slice(p) + pe + b) : l + pe + (p === -2 ? s : b);
    }
...
class St {
    constructor({strings: e, _$litType$: r}, o) {
        ...
        for (; (a = Ee.nextNode()) !== null && l.length < s;) {
            if (a.nodeType === 1) {
                if (a.hasAttributes()) for (const p of a.getAttributeNames()) if (p.endsWith(Pi)) {
                    const v = d[n++], b = a.getAttribute(p).split(pe), w = /([.?@])?(.*)/.exec(v);
                    l.push({
                        type: 1,
                        index: i,
                        name: w[2],
                        strings: b,
                        ctor: w[1] === "." ? tc : w[1] === "?" ? rc : w[1] === "@" ? oc : xr
                    }), a.removeAttribute(p);
                } else p.startsWith(pe) && (l.push({type: 6, index: i}), a.removeAttribute(p));
                if (Ci.test(a.tagName)) {
                    const p = a.textContent.split(pe), v = p.length - 1;
                    if (v > 0) {
                        a.textContent = ir ? ir.emptyScript : "";
                        for (let b = 0; b < v; b++) a.append(p[b], wt()), Ee.nextNode(), l.push({type: 2, index: ++i});
                        a.append(p[v], wt());
                    }
                }
                ...
                let p = -1;
                for (; (p = a.data.indexOf(pe, p + 1)) !== -1;) l.push({type: 7, index: i}), p += pe.length - 1;
            }
            i++;
        }
    }
...
const Xd = {I: it}, ic = uo.litHtmlPolyfillSupport;
...
Be._$litElement$ = !0, Be.finalized = !0, ho.litElementHydrateSupport?.({LitElement: Be});
const sc = ho.litElementPolyfillSupport;
sc?.({LitElement: Be});
(ho.litElementVersions ??= []).push("4.2.0");
...
function dc() {
    kt().publicPluginsState === "NOT_INITIALIZED" && (ae.push(import("./copilot-log-plugin-BUcNhZTq.js")), ae.push(import("./copilot-info-plugin-CdzQtjOc.js")), ae.push(import("./copilot-features-plugin-qY2NgR9n.js")), ae.push(import("./copilot-feedback-plugin-BSdjS3QJ.js")), ae.push(import("./copilot-settings-panel-CvVnWmck.js")), ae.push(import("./copilot-impersonator-plugin-BbiSJySw.js")), ae.push(import("./copilot-development-setup-user-guide-CcktH3uH.js")), Di = !0, kt().setPublicPluginsState("IMPORTED"));
}

function Nr() {
    if (kt().privatePluginsState === "NOT_INITIALIZED") {
        const t = `https://cdn.vaadin.com/copilot/${ul}/copilot-plugins${pl}.js`;
        import(
            /* @vite-ignore */
            t
            ).then(() => {
...
const Jr = window.Vaadin.copilot.overlayManager,
    pc = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
        __proto__: null,
        copilotOverlayManager: Jr
...
const Lc = Rc(Kr), _ = window.Vaadin.copilot._machineState;
if (!_)
...
const Yd = (t, e) => t.error ? (Kc(t.error, e), !0) : !1, ca = (t, e, r) => {
    yr({
        type: Ze.ERROR,
        message: t,
        details: rr(
...
${r}` : "")
    ...
    Dr(e) && e.suggestRestart && go() && (o.details = rr(ce`${t}<br />${r} ${fo()}`), o.delay = 3e4), yr(o);
    let a;
    e instanceof Error ? a = e.stack : Dr(e) ? a = e?.exceptionStacktrace?.join(`
...
function Qc() {
    ...
    if (Array.isArray(e))
        for (const r of e)
            Array.isArray(r) ? zr.push(...r) : zr.push(r);
    Yc((r) => zr.push(r));
}
    ...
    n.nodes.forEach((p) => {
        p.node = s.allNodesFlat.find((v) => {
            if (!v.isFlowComponent)
                return !1;
            const b = v.node;
            return b.uiId === p.uiId && b.nodeId === p.nodeId;
        });
    });
    const c = [];
...
function $c() {
    ...
    function t(e, r = 100, o = {}) {
        ...
        function p() {
            const b = Date.now() - l;
            b < r && b >= 0 ? s = setTimeout(p, r - b) : (s = void 0, a || (c = d()));
        }
...
function $d() {
    vo("use-dev-workflow-guide"), Oe.openPanel(rd);
}
...
function tu() {
    ...
    const t = Ui(), e = od();
    return t === "warning" ? e === "warning" ? {status: "warning", message: "IDE Plugin, Hotswap"} : {
        status: "warning",
        message: "Hotswap is not enabled"
    } : e === "warning" ? {status: "warning", message: "IDE Plugin is not active"} : t === "error" ? {
        status: "error",
...
class id {
    ...
    includeReactNode(e) {
        return ut(e) === "PreconfiguredAuthProvider" || ut(e) === "RouterProvider" ? !1 : Lo(e) || dl(e);
    }
    ...
    async includeFlowNode(e) {
        if (fl(e) || It(e)?.hiddenByServer)
            return !1;
        const r = It(e);
        return r && this.nodeUuidNodeMapFlat.has(pa(r)) ? !1 : this.isInitializedInProjectSources(e);
    }
...
async function Mt() {
    return (await import("./copilot-focus-trap-Bmga1DeA.js")).copilotFocusTrap;
}

async function Zi() {
    return (await Promise.resolve().then(() => pc)).copilotOverlayManager;
}

function dd() {
    return import("./typescript-BZ5KEYlF.js").then((t) => t.t);
}
...
const ji = {
    edit: {
        ...
        onActivation: async () => {
            const t = await Mt();
            t.active || t.activate(), await fa(), Nr();
        }
    },
    test: {
        label: "Test",
        ...
        onActivation: async (t) => {
            (t === "edit" || t === "inspect") && ((await Mt()).deactivate(), await ga()), Nr();
        }
    },
    inspect: {
        label: "Inspect",
...
const wa = (t) => {
    ...
    if (!e)
        return;
    const r = ud(e), o = e.localName === "copilot-main", a = or(e, "copilot-outline-panel") !== null,
    ...
    if (ya(t))
        ...
        if (f.loginCheckActive && f.setLoginCheckActive(!1), vd(e)) {
            t.stopPropagation();
            return;
        }
        y.emit("escape-key-pressed", {event: t});
    } else hd(t) && f.activeMode === "edit" ? (y.emit("delete-selected", {}), s = !0) : (t.ctrlKey || t.metaKey) && t.key === "d" && f.activeMode === "edit" ? (y.emit("duplicate-selected", {}), s = !0) : (t.ctrlKey || t.metaKey) && t.key === "b" ? (y.emit("show-selected-in-ide", {attach: t.shiftKey}), s = !0) : (t.ctrlKey || t.metaKey) && t.key === "z" && pd() ? (y.emit("undoRedo", {undo: !t.shiftKey}), s = !0) : ya(t) || y.emit("keyboard-event", {event: t});
    n && t.stopPropagation(), s && t.preventDefault();
}, hd = (t) => (t.key === "Backspace" || t.key === "Delete") && !t.shiftKey && !t.ctrlKey && !t.altKey && !t.metaKey;
...
const oe = cd(), Ut = "⇧", ou = {
    ...
    fd().then((t) => f.setUserInfo(t)).catch((t) => qe("Failed to load userInfo", t));
}, fd = async () => mr(`${ot}get-user-info`, {}, (t) => (delete t.data.reqId, t.data));
 ...
 */
const Ir = (t) => t ?? S;
var gd = Object.defineProperty, bd = Object.getOwnPropertyDescriptor, be = (t, e, r, o) => {
    for (var a = o > 1 ? void 0 : o ? bd(e, r) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (a = (o ? n(e, r, a) : n(a)) || a);
    return o && a && gd(e, r, a), a;
};
let de = class extends Be {
    ...
    render() {
        return ce`
      <button
        aria-label="${Ir(this.ariaLabel || void 0)}"
        aria-labelledby="${Ir(this.ariaLabelledby || void 0)}"
        aria-describedby="${Ir(this.ariaDescribedby || void 0)}"
...
var md = Object.defineProperty, yd = Object.getOwnPropertyDescriptor, bo = (t, e, r, o) => {
    for (var a = o > 1 ? void 0 : o ? yd(e, r) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (a = (o ? n(e, r, a) : n(a)) || a);
    return o && a && md(e, r, a), a;
};
let nr = class extends cc {
    constructor() {
        super(...arguments), this.removers = [], this.initialized = !1, this.overlayListener = (t) => {
            const {overlay: e} = t.detail, r = e?.owner,
    ...
    async init() {
        if (this.initialized)
            return;
        await window.Vaadin.copilot._machineState.initializer.promise, await import("./copilot-global-vars-later-hSw4yAfB.js"), await import("./copilot-init-step2-BKBlRKJX.js"), hc(), this.tabIndex = 0, window.addEventListener("keydown", Qr), this.addEventListener("keydown", wa), y.onSend(this.handleSendEvent), this.removers.push(
        ...
        ), this.addEventListener("dragover", this.dragOverListener), this.addEventListener("dragleave", this.dragLeaveListener), this.addEventListener("drop", this.dropListener), Jr.addOverlayOutsideClickEvent(), this.setCopilotThemeClass(), this.reaction(
            () => f.activeMode,
            () => {
            ...
            async (e, r) => {
                ...
                Oe.restorePanelsFromStorage(), (e !== "play" || Array.from(Oe.getOpenPanelTags()).some((o) => Fs(o))) && (Wi(), dc(), uc(), await nd()), this.ensureTopmostPopover();
            },
            {fireImmediately: !0}
        ), this.reaction(
            () => _.getSelectedSize(),
    ...
    disconnectedCallback() {
        super.disconnectedCallback(), window.removeEventListener("keydown", Qr), this.removeEventListener("keydown", wa), y.offSend(this.handleSendEvent), this.removers.forEach((t) => t()), this.removeEventListener("dragover", this.dragOverListener), this.removeEventListener("dragleave", this.dragLeaveListener), this.removeEventListener("drop", this.dropListener), Jr.removeOverlayOutsideClickEvent(), document.documentElement.removeEventListener("vaadin-overlay-outside-click", this.overlayOutsideClickListener), document.body.removeEventListener("vaadin-overlay-open", this.overlayListener);
    }
...
bo([
    co("copilot-panel-manager")
], nr.prototype, "panelManager", 2);
nr = bo([
    Oi("copilot-main")
], nr);
const wd = window.Vaadin, xd = {
    init(t) {
        fi(
...
function iu(t, e, r) {
    return Xi(t, r).map((o) => Sd(o, e)).filter((o) => o !== void 0);
}
