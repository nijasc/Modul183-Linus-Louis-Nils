import {aa as g, ab as b, c as y, E as l, M as x, n as v, p as m, q as r, x as i} from "./copilot-CDIH58Wx.js";
import {r as h} from "./state-CdguMiuS.js";
import {B as w} from "./base-panel-BszkQant.js";
import {i as t} from "./icons-DHFxWkZw.js";
import {a as C, c as $} from "./repeat-B4_cH5GR.js";
...
let p = class extends w {
    ...
    renderRow(e) {
        ...
        const a = e.name === "IDE Plugin" && e.value === !0 && r.idePluginState?.ide ? r.idePluginState.ide : e.value,
            n = this.getIcon(e.name, a), o = this.getIconColor(e.name), s = this.getTextColor(e);
        return i`
