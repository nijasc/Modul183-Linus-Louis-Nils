import {a0 as g, c as d, n as k, p as v, P as m, q as f, s as y, x as c, y as h} from "./copilot-CDIH58Wx.js";
import {r as s} from "./state-CdguMiuS.js";
import {B as w} from "./base-panel-BszkQant.js";
import {i as $} from "./icons-DHFxWkZw.js";
...
const F = "https://github.com/vaadin", u = "https://github.com/vaadin/copilot/issues/new",
...
let i = class extends w {
    ...
    openGithub(e, t) {
        ...
        const n = e ? e.replace(/\n/g, "%0A") : "Activate Copilot to include version info.",
            l = `${t.types.find((r) => r.value === this.type)?.ghTitle}`, a = t.description !== "" ? t.description : D,
