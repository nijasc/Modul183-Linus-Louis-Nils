...
import {B as O} from "./base-panel-BszkQant.js";
import {i as x} from "./icons-DHFxWkZw.js";
...
let m = class extends O {
    ...
    toggleFeatureFlag(a, e) {
        ...
        v("use-feature", {
            ...
            enabled: t,
            id: e.id
        }), g.frontendConnection ? (g.frontendConnection.send("setFeature", {
            featureId: e.id,
            enabled: t
        }), e.requiresServerRestart && i.toggleServerRequiringFeatureFlag(e), y({
            type: T.INFORMATION,
